...
func (g *JWTGenerator) GenerateAccessToken(userID string, email string) (string, error) {
...
// ValidateAccessToken verifies a JWT and returns the user ID and email.
func (g *JWTGenerator) ValidateAccessToken(tokenString string) (string, string, error) {
